...
Live Link : [https://vanshitaa-shah.github.io/Scientific-Calculator/](https://vanshitaa-shah.github.io/Scientific-Calculator/)

## Overview :

- This calculator is build Using HTML,CSS and JavaScript (without using Eval function).
- It has many features which helps you solve any equation.
- Max limit of input is set to 25.
...
- It might show Double minus (--) that represents (+) and (---) represents (-).
